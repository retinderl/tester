...
-- ************************************** ADWORKS.DimAccount
CREATE TABLE ADWORKS.DimAccount
(
...
-- ************************************** ADWORKS.DimEmployee
CREATE TABLE ADWORKS.DimEmployee
(
 ...
 CONSTRAINT FK_DimEmployee_403 FOREIGN KEY ( ParentEmployeeKey ) REFERENCES ADWORKS.DimEmployee ( EmployeeKey ),
...
(
 ...
 CONSTRAINT FK_DimCustomer_401 FOREIGN KEY ( GeographyKey ) REFERENCES ADWORKS.DimGeography ( GeographyKey )
)
